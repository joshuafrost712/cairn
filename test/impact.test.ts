...
describe('one case per severity per entity', () => {
  const cases: Array<[string, SetupChange, string]> = [
    ...
    [
      'a scale removal that strands recorded evidence',
      {
        entity: 'scale',
        operation: 'update',
        entityId: null,
        label: 'the grading scale',
        fields: [{ field: 'points', before: 4, after: 3 }],
        counts: {
          scored: 88,
          participants: 12,
          reports: 12,
          removedPoints: 1,
          strandedObservations: 9,
        },
      },
      'destructive',
    ],
    [
      'a scale removal that strands nothing',
      {
        entity: 'scale',
        operation: 'update',
        entityId: null,
        label: 'the grading scale',
        fields: [{ field: 'points', before: 4, after: 3 }],
        counts: { scored: 88, participants: 12, removedPoints: 1, strandedObservations: 0 },
      },
      'invalidates_evidence',
    ],
    [
      'a scale trigger change under scored evidence',
      {
        entity: 'scale',
        operation: 'update',
        entityId: null,
        label: 'the grading scale',
        fields: [{ field: 'points', before: 4, after: 4 }],
        counts: { scored: 88, retriggeredPoints: 1, conversationsAppearing: 6, conversationsStale: 0 },
      },
      'invalidates_evidence',
    ],
    [
      'a scale rename under scored evidence, which rescores nothing',
      {
        entity: 'scale',
        operation: 'update',
        entityId: null,
        label: 'the grading scale',
        fields: [{ field: 'points', before: 4, after: 4 }],
        counts: { scored: 88, rewordedPoints: 2 },
      },
      'affects_future',
    ],
    [
      'adding a scale point under scored evidence',
      {
        entity: 'scale',
        operation: 'update',
        entityId: null,
        ...
        counts: { scored: 88, addedPoints: 1 },
      },
      'affects_future',
    ],
    [
