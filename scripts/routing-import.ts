...
//
//   npx tsx scripts/routing-import.ts --dir .routing-workspace/<id> --outbox outbox-haiku --dry-run
//   npx tsx scripts/routing-import.ts --dir .routing-workspace/<id> --outbox outbox-haiku
//
